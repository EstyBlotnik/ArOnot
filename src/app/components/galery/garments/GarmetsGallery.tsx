    ...
    return (
        <>
            {!sortedGarments.length && 
             <div className="px-6">
             <p>לא נמצאו בגדים עבור משתמש זה </p>
             <Link href="/pages/user/garment_form" className="text-blue-500 hover:text-blue-700 underline font-medium">
                 מעבר לעמוד יצירת בגד
             </Link>
           </div>}
