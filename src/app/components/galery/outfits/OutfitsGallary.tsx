  ...
  return (
    <>
      {!sortedOutfits.length &&
        <div className="px-6">
          <p>לא נמצאו לוקים עבור משתמש זה </p>
          <Link href="/pages/user/outfit_canvas" className="text-blue-500 hover:text-blue-700 underline font-medium">
              מעבר לעמוד יצירת לוק
          </Link>
        </div>}
